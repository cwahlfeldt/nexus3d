...
typedef struct {
    ...
    bool keys_pressed[SDL_SCANCODE_COUNT]; /* Keys pressed this frame */
    bool keys_released[SDL_SCANCODE_COUNT]; /* Keys released this frame */
    bool keys_prev[SDL_SCANCODE_COUNT];  /* Previous frame key state */
